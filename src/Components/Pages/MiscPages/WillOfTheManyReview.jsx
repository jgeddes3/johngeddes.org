...
const WillOfTheManyReview = () => {
  const title = 'Will of the Many';
  const ratingOutOf10 = 7;
  const authorName = 'James Islington';
...
Check back later for the full review.
  ...
  return (
    <>
      <SEO
        title="Will of the Many Review"
        description="John Geddes' review of Will of the Many by James Islington — rated 7/10. The full written review is coming soon; check back for his complete thoughts."
        path="/WillOfTheManyReview"
      />
      <Background />
...
export default WillOfTheManyReview;
