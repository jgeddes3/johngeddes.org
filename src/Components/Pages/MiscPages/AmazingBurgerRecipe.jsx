    ...
    <>
      ...
      <div className="restaurant-container main-content">
        ...
        <div className = "Seperator-photo-right">
          <p>
          The egg keeps everything together so the patty doesn't fall apart on the grill, and it helps keep it juicy.
          And the Worcestershire sauce — I don't know what it is about it, but it just makes the meat taste meatier somehow. Like it brings out something you didn't know was missing.
