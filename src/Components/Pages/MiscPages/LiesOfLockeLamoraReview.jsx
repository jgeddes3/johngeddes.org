...
const LiesOfLockeLamoraReview = () => {
  const title = 'The Lies of Locke Lamora';
  const ratingOutOf10 = 10;
  const authorName = 'Scott Lynch';
...
Check back later for the full review.
  ...
  return (
    <>
      <SEO
        title="The Lies of Locke Lamora Review"
        description="John Geddes' review of The Lies of Locke Lamora by Scott Lynch — a perfect 10/10. The full written review is coming soon; check back for his thoughts."
        path="/LiesOfLockeLamoraReview"
      />
      <Background />
...
export default LiesOfLockeLamoraReview;
