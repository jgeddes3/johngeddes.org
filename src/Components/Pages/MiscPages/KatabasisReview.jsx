...
Check back later for the full review.
  ...
  return (
    <>
      <SEO
        title="Katabasis Review"
        description="John Geddes' review of Katabasis — rated 8/10 on his book review scale. The full written review is coming soon; check back for his complete thoughts."
        path="/KatabasisReview"
      />
      <Background />
...
export default KatabasisReview;
