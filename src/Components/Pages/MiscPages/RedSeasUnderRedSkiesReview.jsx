...
const RedSeasUnderRedSkiesReview = () => {
  const title = 'Red Seas Under Red Skies';
...
Check back later for the full review.
  ...
  return (
    <>
      <SEO
        title="Red Seas Under Red Skies Review"
        description="John Geddes' review of Red Seas Under Red Skies by Scott Lynch — rated 8/10. The full written review is coming soon; check back for his thoughts."
        path="/RedSeasUnderRedSkiesReview"
      />
      <Background />
...
export default RedSeasUnderRedSkiesReview;
