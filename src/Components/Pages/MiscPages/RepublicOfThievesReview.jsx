...
const RepublicOfThievesReview = () => {
  const title = 'Republic of Thieves';
...
Check back later for the full review.
  ...
  return (
    <>
      <SEO
        title="Republic of Thieves Review"
        description="John Geddes' review of Republic of Thieves by Scott Lynch — rated 9/10. The full written review is coming soon; check back for his complete thoughts."
        path="/RepublicOfThievesReview"
      />
      <Background />
...
export default RepublicOfThievesReview;
