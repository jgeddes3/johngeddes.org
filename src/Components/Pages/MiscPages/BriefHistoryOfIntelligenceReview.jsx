...
const BriefHistoryOfIntelligenceReview = () => {
  const title = 'A Brief History of Intelligence';
  const ratingOutOf10 = 4;
  const authorName = 'Max Bennett';
...
export default BriefHistoryOfIntelligenceReview;
