...
const StrengthOfTheFewReview = () => {
  const title = 'Strength of the Few';
...
Check back later for the full review.
  ...
  return (
    <>
      <SEO
        title="Strength of the Few Review"
        description="John Geddes' review of Strength of the Few by James Islington — rated 9/10. The full written review is coming soon; check back for his complete thoughts."
        path="/StrengthOfTheFewReview"
      />
      <Background />
...
export default StrengthOfTheFewReview;
